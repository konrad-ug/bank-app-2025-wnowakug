...
class TestPrzelewy:
    def test_express_transfer_company_account_takes_fee(self,sender,receiver):
    ...
    def test_express_transfer_company_can_go_minus_five(self,sender,receiver):
    ...
    def test_express_transfer_company_blocked_below_minus_five(self,sender,receiver):
    ...
    def test_express_transfer_uses_overdraft_limit(self,sender,receiver):
        ...
        assert sender.balance == -5

    def test_company_transfer_blocked_when_insufficient_funds(self,sender,receiver):
